...
export const BucketScriptSettingsEditor = ({ value, previousMetrics }: Props) => {
  ...
  const dispatch = useStatelessReducer(
    (newState) =>
      upperStateDispatch(changeMetricAttribute({ metric: value, attribute: 'pipelineVariables', newValue: newState })),
  ...
  }, [value.pipelineVariables?.length, dispatch]);
  ...
  return (
    <>
      ...
      <SettingField
        ...
        metric={value}
        settingName="script"
        tooltip="Scripting language is Painless. Use params.<var> to reference a variable."

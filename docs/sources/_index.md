...
You can request new features, report issues, or contribute code directly through the [OpenSearch plugin Github repository](https://github.com/grafana/opensearch-datasource/)